...
// router.get() 콜백함수, 함수
// function(req,res) {  }
// req(request) : client(web browser)가 요청하는 여러가지 정보를 담고 와서
//    서버에 전달해주는 역할 수행
// res(response) : 서버가 client에게 응답하는 것들이 담겨있다.
router.get('/', function(req, res, next) {
  // views/index.pug 파일을 읽어서 rendering 한 후
  // client에게 응답하라
  // title이라는 변수에 Express라는 문자열을 담고
  // rendering할때 index.pug에게 전달하라
  res.render('index', { title: '태양만세!!!' });
});
